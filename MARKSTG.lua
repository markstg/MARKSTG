...
local files_RAMBO = database:smembers("files"..bot_id)
print(Green.."\nFiles Now Started : \n "..reset)
for i,v in pairs(files_RAMBO) do
print(Blue..i..red..' - \27[10;33m'..v..',\27[m')  end
print(Green.."\nThes all Files.\n\n\n"..reset)
io.popen("mkdir files_RAMBO")
...
{
{text = ''..(channel_ts or "LE_C4_KR")..'', url=''..(channel_user_ts or 't.me/LE_C4_KR')..''},
},
}
...
for RAMBO_one in string.gmatch(result.first_name_, "[^%s]+") do
result.first_name_ = RAMBO_one
break
end
end
end 
info = '👁‍🗨 ¦¬ بوآسـطـه ⚜ ⌁≻ ['..result.first_name_..'](t.me/'..(result.username_ or 'LE_C4_KR')..')\n'..text
send(msg.chat_id_, msg.id_, 1,info, 1, 'md')
end
getUser(msg.sender_user_id_, keko333)
end
if value == "prore" then
function get_RAMBOR(RAMBOr1,RAMBOr2,RAMBOr3)
local id_RAMBOr = RAMBOr2.sender_user_id_
function keko333(extra,result,success)
if result.first_name_ then
if #result.first_name_ < 15 then 
else
...
info = '🔳 العـضو 💳 ⌁≻ ['..result.first_name_..'](t.me/'..(result.username_ or 'LE_C4_KR')..')\n'..text
send(msg.chat_id_, msg.id_, 1,info, 1, 'md')
end
getUser(id_RAMBOr, keko333)
end
getMessage(msg.chat_id_, msg.reply_to_message_id_,get_RAMBOR)
end
...
info = '🔳 العـضو 💳 ⌁≻ ['..(result.first_name_ or value)..'](t.me/'..(result.username_ or 'LE_C4_KR')..')\n'..text
send(msg.chat_id_, msg.id_, 1,info, 1, 'md')
end
...
info = '🚦¦عزيزي المطور ⌁≻ ['..result.first_name_..'](t.me/'..(result.username_ or 'LE_C4_KR')..')\n'
...
openChat(msg.chat_id_,RAMBO_info2) 
--
end
else
...
if tsX_o then
tsX000("lock",msg,"✔┇ التاك بلفعل مقفول 📛")
else
tsX000("lock",msg,"🚦¦ تم بلفعل قفل  الـتاك ❌")
...
if tsX_o then
tsX000("lock",msg,"✔┇الشارحه بلفعل مقفولة 📛")
else
tsX000("lock",msg,"🚦¦ تم بلفعل قفل  الـشارحه ❌")
...
tsX000("lock",msg,"🚦¦ تم بلفعل قفل  تعديل الـميديا ❌")
...
if tsX_o then
tsX000("lock",msg,"✔┇الكلايش بلفعل مقفولة 📛")
else
tsX000("lock",msg,"🚦¦ تم بلفعل قفل  الـكلايش ❌")
...
if tsX_o then
tsX000("lock",msg,"✔┇التعديل بلفعل مقفول 📛")
else
tsX000("lock",msg,"🚦¦ تم بلفعل قفل  الـتعديل ❌")
...
if tsX_o then
tsX000("lock",msg,"✔┇التكرار بلفعل مقفول 📛")
else
tsX000("lock",msg,"🚦¦ تم بلفعل قفل  الـتكرار ❌")
...
if tsX_o then
tsX000("lock",msg,"✔┇المتحركه بلفعل مقفولة 📛")
else
tsX000("lock",msg,"🚦¦ تم بلفعل قفل  الـمتحركه ❌")
...
if tsX_o then
tsX000("lock",msg,"✔┇الملفات بلفعل مقفولة 📛")
else
tsX000("lock",msg,"🚦¦ تم بلفعل قفل  الـملفات ❌")
...
if tsX_o then
tsX000("lock",msg,"✔┇الماركدون بلفعل مقفول 📛")
else
tsX000("lock",msg,"🚦¦ تم بلفعل قفل  الـماركدون ❌")
...
if tsX_o then
tsX000("lock",msg,"✔┇الصور بلفعل مقفولة 📛")
else
tsX000("lock",msg,"🚦¦ تم بلفعل قفل  الـصور ❌")
...
if tsX_o then
tsX000("lock",msg,"✔┇الملصقات بلفعل مقفولة 📛")
else
tsX000("lock",msg,"🚦¦ تم بلفعل قفل  الـملصقات ❌")
...
if tsX_o then
tsX000("lock",msg,"✔┇الفيديو بلفعل مقفول 📛")
else
tsX000("lock",msg,"🚦¦ تم بلفعل قفل  الـفيديو ❌")
...
if tsX_o then
tsX000("lock",msg,"✔┇الانلاين بلفعل مقفول 📛")
else
tsX000("lock",msg,"🚦¦ تم بلفعل قفل  الانلاين ❌")
...
if tsX_o then
tsX000("lock",msg,"✔┇الدردشه بلفعل مقفولة 📛")
else
tsX000("lock",msg,"🚦¦ تم بلفعل قفل  الـدردشه ❌")
...
if tsX_o then
tsX000("lock",msg,"✔┇التوجيه بلفعل مقفول 📛")
else
tsX000("lock",msg,"🚦¦ تم بلفعل قفل  الـتوجيه ❌")
...
if tsX_o then
tsX000("lock",msg,"✔┇التثبيت بلفعل مقفول 📛")
else
tsX000("lock",msg,"🚦¦ تم بلفعل قفل  الـتثبيت ❌")
...
if tsX_o then
tsX000("lock",msg,"✔┇الاغاني بلفعل مقفولة 📛")
else
tsX000("lock",msg,"🚦¦ تم بلفعل قفل  الاغاني ❌")
...
if tsX_o then
tsX000("lock",msg,"✔┇الصوت بلفعل مقفول 📛")
else
tsX000("lock",msg,"🚦¦ تم بلفعل قفل  الـصوت ❌")
...
if tsX_o then
tsX000("lock",msg,"✔┇الجهات بلفعل مقفولة 📛")
else
tsX000("lock",msg,"🚦¦ تم بلفعل قفل  الـجهات ❌")
...
tsX000("lock",msg,"🚦¦ تم بلفعل قفل  الـعربيه ❌")
...
tsX000("lock",msg,"🚦¦ تم بلفعل قفل  الانكليزيه ❌")
...
if tsX_o then
tsX000("lock",msg,"✔┇الميديا بلفعل مقفولة 📛")
else
tsX000("lock",msg,"🚦¦ تم بلفعل قفل  الـميديا ❌")
...
if tsX_o then
tsX000("lock",msg,"✔️┇الروابط بلفعل مقفولة 📛")
else
tsX000("lock",msg,"🚦¦ تم بلفعل قفل  الـروابط ❌")
...
if tsX_o then
tsX000("lock",msg,"✔┇اليوزر بلفعل مقفول 📛")
else
tsX000("lock",msg,"🚦¦ تم بلفعل قفل  الـيوزر ❌")
...
if tsX_o then
tsX000("lock",msg,"✔┇الاشعارات بلفعل مقفولة 📛")
else
tsX000("lock",msg,"🚦¦ تم بلفعل قفل  الاشعارات ❌")
...
if tsX_o then
tsX000("lock",msg,"✔┇البوتات بالطرد بلفعل مقفولة 📛 ")
else
tsX000("lock",msg,"🚦¦ تم بلفعل قفل  الـبوتات بالطرد ❌")
...
tsX000("lock",msg,"🚦¦ تم بلفعل قفل  الـبوتات ❌")
...
tsX000("lock",msg,"🚦¦ تم بلفعل قفل  بصمه فيديو ❌")
database:set("lock_note:MARKSTG"..msg.chat_id_..bot_id,"ok")
end
end
--         »»                 End MARKSTG lock                         ««              --
--         »»               Start MARKSTG unlock                       ««              --
if (text == "فتح الاشعارات") then
local tsX_o = database:get("lock_new:MARKSTG"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"✔️┇الاشعارات مفتوحه⛔️")
else
tsX000("lock",msg,"🚦¦ تم بلفعل فتح  الاشعارات ✔️")
...
tsX000("lock",msg,"🚦¦ تم بلفعل فتح  الـتاك ✔️")
...
tsX000("lock",msg,"🚦¦ تم بلفعل فتح  الـكلايش ✔️")
...
tsX000("lock",msg,"🚦¦ تم بلفعل فتح  تعديل الـميديا ✔️")
...
tsX000("lock",msg,"🚦¦ تم بلفعل فتح  الـشارحه ✔️")
...
tsX000("lock",msg,"🚦¦ تم بلفعل فتح  الـتكرار ✔️")
...
tsX000("lock",msg,"🚦¦ تم بلفعل فتح  الـتعديل ✔️")
...
tsX000("lock",msg,"🚦¦ تم بلفعل فتح  الـمتحركه ✔️")
...
tsX000("lock",msg,"🚦¦ تم بلفعل فتح  الـملفات ✔️")
...
tsX000("lock",msg,"🚦¦ تم بلفعل فتح  الـماركدون ✔️")
...
tsX000("lock",msg,"🚦¦ تم بلفعل فتح  الـصور ✔️")
...
tsX000("lock",msg,"🚦¦ تم بلفعل فتح  الـملصقات ✔️")
...
tsX000("lock",msg,"🚦¦ تم بلفعل فتح  الـفيديو ✔️")
...
tsX000("lock",msg,"🚦¦ تم بلفعل فتح  الانلاين ✔️")
...
tsX000("lock",msg,"🚦¦ تم بلفعل فتح  الـدردشه ✔️")
...
tsX000("lock",msg,"🚦¦ تم بلفعل فتح  الـتوجيه ✔️")
...
tsX000("lock",msg,"🚦¦ تم بلفعل فتح  الـتثبيت ✔️")
...
tsX000("lock",msg,"🚦¦ تم بلفعل فتح  الاغاني ✔️")
...
tsX000("lock",msg,"🚦¦ تم بلفعل فتح  الـصوت ✔️")
...
tsX000("lock",msg,"🚦¦ تم بلفعل فتح  الـبوتات بالطرد ✔️")
...
tsX000("lock",msg,"🚦¦ تم بلفعل فتح  الـجهات ✔️")
...
tsX000("lock",msg,"🚦¦ تم بلفعل فتح  الـعربيه ✔️")
...
tsX000("lock",msg,"🚦¦ تم بلفعل فتح  الانكليزيه ✔️")
...
tsX000("lock",msg,"🚦¦ تم بلفعل فتح  الـميديا ✔️")
...
tsX000("lock",msg,"🚦¦ تم بلفعل فتح  الـيوزر ✔️")
...
tsX000("lock",msg,"🚦¦ تم بلفعل فتح  بصمه فيديو ✔️")
database:del("lock_note:MARKSTG"..msg.chat_id_..bot_id,"ok")
end
end
...
tsX000("lock",msg,"🚦¦ تم بلفعل فتح  الـروابط ✔️")
...
tsX000("lock",msg,"🚦¦ تم بلفعل فتح  الـبوتات ✔️")
...
local RAMBO_wr = (database:get("MARKSTG:not:word:"..bot_id..msg.chat_id_) or 100)
if #text >= tonumber(RAMBO_wr) then
...
floodRAMBO = tonumber(database:get(hash))
end
...
texts = '🔳 العـضو 💳  ⌁≻ ['..result.title_..'](t.me/'..(apow[2] or 'LE_C4_KR')..')\n🔲 تـم ترقـيته وأصبح منـشئٰ في المجموعة ✔️'
else
...
f:write(text)
f:close()
local RAMBOe = 'https://api.telegram.org/bot' .. token .. '/sendDocument'
local curl = 'curl "' .. RAMBOe .. '" -F "chat_id=' .. msg.chat_id_ .. '" -F "document=@' .. 'MARKSTG.txt' .. '"'
io.popen(curl)
end
if text:match("^تحديث السورس$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
send(msg.chat_id_, msg.id_, 1, '- 🗂¦ تم تحديث السورس 🚦', 1, 'md')
os.execute('rm -rf ./libs/utils.lua')
os.execute('cd libs && wget https://raw.github.com/ramizob3a/MARKSTG/master/libs/utils.lua')
os.execute('rm -rf MARKSTG.lua')
os.execute('wget https://raw.github.com/ramizob3a/MARKSTG/master/MARKSTG.lua')
os.exit()
return false
end
...
local files_RAMBO = database:smembers("files"..bot_id)
local keko = io.popen('cd files_RAMBO && ls'):read("*all")
local files_RAMBO2 = ''
for i=1,#files_RAMBO do
files_RAMBO2 = files_RAMBO2..'{'..files_RAMBO[i]..'}\n'
end
send(msg.chat_id_, msg.id_, 1, '🗂¦ عدد الملفات الكلي : \n '..keko..'\n ---------------------- \n\n🗂¦ الملفات المفعله \n'..files_RAMBO2..'', 1, 'html')
end
text = msg.content_.text_
if text then
...
local f = load("files_RAMBO/"..name_t[2]..".lua")
if f ~= "keko" then
ts23 = ""
if f:match("^(.*)(keko_RAMBO)(.*)$") then
...
io.popen("rm -fr files_RAMBO/"..name_t[2]..'.lua')
database:srem("files"..bot_id,name_t[2]..'.lua')
...
local RAMBOe = 'https://api.telegram.org/bot' .. token .. '/sendDocument'
local curl = 'curl "' .. RAMBOe .. '" -F "chat_id=' .. msg.chat_id_ .. '" -F "document=@' .. 'files_RAMBO/'..name_t[2]..'.lua' .. '"'
io.popen(curl)
end
end
end -- end if sudo
...
function RAMBO_run_file(data)
local files_RAMBO = database:smembers("files"..bot_id)
for i=1,#files_RAMBO do
local RAMBOee = dofile("files_RAMBO/"..files_RAMBO[i])
local kt = RAMBOee.keko_RAMBO(data)
if kt == 'end' then
return false
end
end
...
local RAMBO_edis = {string.match(text, "^اضف امر (.*)$")}
send(msg.chat_id_, msg.id_, 1, "🚦¦ ارسال الان الامر الجديد", 1, 'md')
database:set("MARKSTG:new:msg:"..msg.chat_id_..msg.sender_user_id_..bot_id,RAMBO_edis[1])
...
texts = ' 🔳 العـضو 💳 ⌁≻ ['..result.title_..'](t.me/'..(apmd[2] or 'LE_C4_KR')..')\n🔲 تـم ترقـيته وأصبح أدمـن في المجموعة ✔️'
else
texts = '✖┇خطاء'
end
send(msg.chat_id_, msg.id_, 1, texts, 1, 'md')
...
texts = '🚦¦العضو ⌁≻ ['..result.title_..'](t.me/'..(apmd[2] or 'LE_C4_KR')..')\n🚦¦تم رفعه مميز'
else
texts = '✖┇خطاء'
end
send(msg.chat_id_, msg.id_, 1, texts, 1, 'md')
...
texts = '🚦¦العضو ⌁≻ ['..result.title_..'](t.me/'..(apba[2] or 'LE_C4_KR')..')\n🚦¦تم حظره من المجموعه'
...
local hash =  'MARKSTG:'..bot_id..'gbanned:'
texts = '🚦¦العضو ⌁≻ ['..result.title_..'](t.me/'..(apbll[2] or 'LE_C4_KR')..')\n🚫┇تم حظره من مجموعات البوت'
...
local hash =  'MARKSTG:'..bot_id..'gbanned:'
if result.id_ then
texts = '🚦¦العضو ⌁≻ ['..result.title_..'](t.me/'..(apid[2] or 'LE_C4_KR')..')\n🚫┇تم الغاء حظره من مجموعات البوت'
database:srem(hash, result.id_)
else
texts = '✖┇خطاء'
end
...
texts = '🚦¦العضو ⌁≻ ['..result.title_..'](t.me/'..(apsi[2] or 'LE_C4_KR')..')\n🚫┇تم كتمه من البوت'
end
else
texts = '✖┇خطاء'
end
...
texts = '🚦¦العضو ⌁≻ ['..result.title_..'](t.me/'..(apki[2] or 'LE_C4_KR')..')\n🚫┇تم طرده من المجموعه'
chat_kick(msg.chat_id_, result.id_)
end
else
texts = '✖┇خطاء'
...
texts = '🚦¦العضو ⌁≻ ['..result.title_..'](t.me/'..(apow[2] or 'LE_C4_KR')..')\n🚦¦تم رفع اداري في البوت'
else
texts = '✖┇خطاء'
end
send(msg.chat_id_, msg.id_, 1, texts, 1, 'md')
...
database:set("MARKSTG:mute:deleta:msg:"..bot_id..msg.chat_id_,"RAMBOE")
...
RAMBO_oop = 'مطور البوت'
elseif is_creator(msg) then
RAMBO_oop = 'منشئ الكروب'
...
RAMBO_oop = database:get("MARKSTG:name_user:"..bot_id..msg.chat_id_..result.sender_user_id_)
elseif is_owner(msg2) then
RAMBO_oop = 'اداري الكروب'
elseif ck_mod(result.sender_user_id_,msg.chat_id_) then
RAMBO_oop = 'ادمن للكروب'
elseif is_vip(msg2) then
RAMBO_oop = 'مميز الكروب'
else
RAMBO_oop = 'لا شيء'
end
...
RAMBO_oop = database:get("MARKSTG:name_user:"..bot_id..msg.chat_id_..result.id_)
elseif is_owner(msg2) then
RAMBO_oop = 'اداري الكروب'
...
if text:match("^صورتي (%d+)$") and msg.reply_to_message_id_ == 0 and not database:get('MARKSTG:'..bot_id..'get:photo'..msg.chat_id_) then
...
local floodRAMBO = {string.match(text, "^(وضع تكرار) (%d+)$")}
if tonumber(floodRAMBO[2]) < 2 then
send(msg.chat_id_, msg.id_, 1, '🚦¦ضع التكرار من *{2}* الى  *{99999}*', 1, 'md')
else
database:set('MARKSTG:'..bot_id..'flood:MARKSTG:'..msg.chat_id_,floodRAMBO[2])
send(msg.chat_id_, msg.id_, 1, '☑┇تم  وضع التكرار بالطرد للعدد ⌁≻  *{'..floodRAMBO[2]..'}*', 1, 'md')
end
end
...
database:del('MARKSTG:'..bot_id..'user:msgs'..msg.chat_id_..':'..msg.sender_user_id_)
else
end
end
...
RAMBO_0 = {string.match(text, "^(تعين عدد الاحرف) (%d+)$")}
send(msg.chat_id_, msg.id_, 1, '☑┇ تم تعين عدد الاحرف {`'..RAMBO_0[2]..'`}', 1, 'md')
database:set("MARKSTG:not:word:"..bot_id..msg.chat_id_,RAMBO_0[2])
end
...
getUser(msg.sender_user_id_, keko_RAMBO_re)
...
info = '🚦¦العضو ⌁≻ ['..result2.first_name_..'](t.me/'..(result2.username_ or 'LE_C4_KR')..')\n☑┇تم رفعه '..a[1]
send(msg.chat_id_, msg.id_, 1,info, 1, 'md')
end
...
local all_photo_RAMBO = result.total_count_ 
local user_msgs = database:get('MARKSTG:'..bot_id..'user:msgs'..msg.chat_id_..':'..msg.sender_user_id_)
...
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_,"🎭"..keko_text[keko3].."\n🖼¦ صورك •⊱ "..all_photo_RAMBO.."\n🎟¦ ايديــك •⊱ ("..msg.sender_user_id_..")\n🎫¦ مـعرفك •⊱ "..keko_info.."\n🎖¦ رتبتـــك •⊱ "..t..'\n⭐️¦ تفاعـلك •⊱ '..formsgg(msguser).."\n💬¦ رسائلك •⊱ {"..user_msgs.."}\n🛠¦ تعديلاتك •⊱ {"..edit.."}\nֆ • • • • • • • ֆ ",msg.id_,msg.id_.."")
else 
local RAMBO_new_text = database:get("MARKSTG:gr:id:text:"..bot_id..msg.chat_id_)
local RAMBO_new_text = RAMBO_new_text:gsub('#username',(keko_info or 'لا يوجد'))
local RAMBO_new_text = RAMBO_new_text:gsub('#id',(msg.sender_user_id_ or 'لا يوجد'))
local RAMBO_new_text = RAMBO_new_text:gsub('#edit',(edit or 'لا يوجد'))
local RAMBO_new_text = RAMBO_new_text:gsub('#msgs',(user_msgs or 'لا يوجد'))
local RAMBO_new_text = RAMBO_new_text:gsub('#stast',(t or 'لا يوجد'))
local RAMBO_new_text = RAMBO_new_text:gsub('#photos',(all_photo_RAMBO or 'لا يوجد'))
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_,RAMBO_new_text,msg.id_,msg.id_.."")
end
else
if is_sudo(msg) then
t = 'مطور البوت'
...
local RAMBO_new_text = RAMBO_new_text:gsub('#stast',(t or 'لا يوجد'))   
local RAMBO_new_text = RAMBO_new_text:gsub('#photos',(all_photo_RAMBO or 'لا يوجد'))
send(msg.chat_id_, msg.id_, 1, RAMBO_new_text, 1, 'html')
end   
end
else
end
...
local text =  [[
  ‌‎⚙️|اهلا بك عزيزي اليك اوامر البوت
...
local text =  [[
  ...
  ⛔️| 《 تعين »» مسح 》 ايدي
  ⛔️| 《 ضف »» مسح 》 صلاحيه
  ⛔️| 《 اضف »» مسح 》 امر + اسم الامر المضاف
  ⛔️| 《 مسح + عدد 》 لمسح الرسائل
  ⛔️| 《 ردود الاداري 》 لعرض الردود المضافه
﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎
📡 | Ch •⊱ @LE_C4_KR
]]
...
📮┊اهلا بك في سورس رامبو                      
  ﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎
git clone https://github.com/ramizob3a/MARKSTG && cd MARKSTG && chmod +x install.sh && ./install.sh
﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎  
✅┊طريقة التنصيب،☢️
﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎
...
📁|<a href="https://telegram.me/LE_C4_KRFiles">ملفات السورس○•</a>

💬|<a href="t.me/LE_C4_KR_BOT">بوت تواصل السورس○•</a>
 
👨‍🔧|<a href="https://t.me/LE_C4_KR">مطور السورس👨‍🔧</a>
 
👨‍🔧|<a href="t.me/RAMBO_SYR">RAMI○•</a>
]]
send(msg.chat_id_, msg.id_, 1, text, 1, 'html')
end
...
z_RAMBO = TSCheckMsg(msg)
if z_RAMBO and z_RAMBO == "stop" then 
if database:get("lock_lllll:MARKSTG"..msg.chat_id_..bot_id) then
local hash = 'flood:MARKSTG:'..bot_id..msg.chat_id_
if not database:get(hash) then
floodRAMBO = 10
...
local RAMBO_edit_text = database:get("MARKSTG:edit:text:su:new2:"..bot_id..data.message_.chat_id_..data.message_.content_.text_)
if RAMBO_edit_text then
data.message_.content_.text_ = RAMBO_edit_text
end
end
end
...
local photo_keko = download_to_file('https://api.telegram.org/file/bot'..token..'/'..keko6.result.file_path, 'files_RAMBO/'..msg.content_.document_.file_name_)
