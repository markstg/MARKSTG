...
if text:match("^تفاعلي$") and msg.reply_to_message_id_ == 0 then
    local markx_info = nil
    function markx333(extra,result,success)
    markx_info = '@'..(result.username_ or 'لا يوجد')..''
    ...
    sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_,"🌌┐ "..markx_text[markx3].."اهلا وسهلا بك في نسبة التفاعل\n📡┤رتبتك~⊱ "..t..'\n🌟┤تفاعلك~⊱ {'..formsgg(msguser).."}\n🚸┤معرفك~⊱ "..markx_info.."\n💌┤رسائلك~⊱ {"..user_msgs.."}\n📝┘سحكاتك~⊱ {"..edit.."}\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉",msg.id_,msg.id_.."")
    else 
