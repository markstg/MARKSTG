...
keko = keko .. '&reply_to_message_id=' .. reply_to_message_id/2097152/0.5 -- جميع الحقوق محفوظه لفريق ماركس لايمكنك نسخ او استخدام هذه السطر بدون موافقه الفريق
end
...
if value == "prore" then
function get_MARKSTGR(MARKSTGr1,MARKSTGr2,MARKSTGr3)
local id_MARKSTGr = MARKSTGr2.sender_user_id_
function keko333(extra,result,success)
if result.first_name_ then
if #result.first_name_ < 15 then 
else
...
getUser(id_MARKSTGr, keko333)
end
getMessage(msg.chat_id_, msg.reply_to_message_id_,get_MARKSTGR)
end
...
send(msg.chat_id_, msg.id_, 1, "🚦¦لا يمكنك تفعيلي انت لست (منشئ او مدير) في المجموعة", 1, 'md')
end
end
end
...
sendContact(msg.chat_id_, msg.id_, 0, 1, nil, (nkeko or 9630), (nakeko or "DEVIL TEAM"), "", bot_id)
end
end
for k,v in pairs(sudo_users) do
...
local text =  [[
  ...
  ⛔️| ردود المدير + لعرض الردود المضافه
﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎
📡 | Ch •⊱ @LE_C4_KR
]]
...
local text =  [[
    ...
    🌐┇MARKS                
        ...
        📁┇<a href="https://telegram.me/LE_C4_KR">ملفات السورس</a>
        
        🔎|<a href="t.me/VIP_12K_BOT">بوت تواصل السورس○•</a>
         
        🚸|<a href="https://t.me/P_PPPP">مطور السورس</a>
         
        👨‍🔧|<a href="t.me/P_PPPP">MARKS</a>
]]
send(msg.chat_id_, msg.id_, 1, text, 1, 'html')
end
