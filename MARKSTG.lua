...
📮┊اهلا بك في سورس ماركس                      
  ﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎
git clone https://github.com/markstg/MARKSTG && cd MARKSTG && chmod +x install.sh && ./install.sh
﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎  
✅┊طريقة التنصيب،☢️
﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎
...
👨‍🔧|<a href="t.me/MARKSTG_SYR">RAMI○•</a>
]]
send(msg.chat_id_, msg.id_, 1, text, 1, 'html')
end
