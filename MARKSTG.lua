...
info = '👨┇العضو ⌁≻ ['..result.first_name_..'](t.me/'..(result.username_ or 'MARKS_TEAM')..')\n'..text
send(msg.chat_id_, msg.id_, 1,info, 1, 'md')
end
...
info = '👨┇العضو ⌁≻ ['..(result.first_name_ or value)..'](t.me/'..(result.username_ or 'MARKS_TEAM')..')\n'..text
send(msg.chat_id_, msg.id_, 1,info, 1, 'md')
end
...
if tsX_o then
tsX000("lock",msg,"🚦: مرحبا عزيزي\n♠️: تم قفل البوتات بالطر •")
else
tsX000("lock",msg,"🗄: خاصيه القفل\n♠️: تم قفل البوتات بالطرد •")
database:set("lock_botAndBan:MARKSTG"..msg.chat_id_..bot_id,"ok")
end
end
...
texts = '👨┇العضو ⌁≻ ['..result.title_..'](t.me/'..(apow[2] or 'MARKS_TEAM')..')\n☑┇تم رفع منشئ في البوت'
else
texts = '✖┇خطاء'
end
...
texts = '👨┇العضو ⌁≻ ['..result.title_..'](t.me/'..(apba[2] or 'MARKS_TEAM')..')\n☑┇تم حظره من المجموعه'
...
local hash =  'MARKSTG:'..bot_id..'gbanned:'
texts = '👨┇العضو ⌁≻ ['..result.title_..'](t.me/'..(apbll[2] or 'MARKS_TEAM')..')\n🚫┇تم حظره من المجموعات البوت'
...
local hash =  'MARKSTG:'..bot_id..'gbanned:'
if result.id_ then
texts = '👨┇العضو ⌁≻ ['..result.title_..'](t.me/'..(apid[2] or 'MARKS_TEAM')..')\n🚫┇تم الغاء حظره من المجموعات البوت'
database:srem(hash, result.id_)
else
texts = '✖┇خطاء'
end
...
texts = '👨┇العضو ⌁≻ ['..result.title_..'](t.me/'..(apsi[2] or 'MARKS_TEAM')..')\n🚫┇تم كتمه من البوت'
end
else
texts = '✖┇خطاء'
end
...
texts = '👨┇العضو ⌁≻ ['..result.title_..'](t.me/'..(apki[2] or 'MARKS_TEAM')..')\n🚫┇تم طرده من المجموعه'
chat_kick(msg.chat_id_, result.id_)
end
else
texts = '✖┇خطاء'
...
info = '👨┇العضو ⌁≻ ['..result2.first_name_..'](t.me/'..(result2.username_ or 'MARKSTGTeam')..')\n☑┇تم رفعه '..a[1]
send(msg.chat_id_, msg.id_, 1,info, 1, 'md')
end
...
if not database:get('MARKSTG:'..bot_id..'repowner:mute'..msg.chat_id_) then
send(msg.chat_id_, msg.id_, 1, '☑┇ردود المدير عام بالفعل تم تفعيلها', 1, 'md')
else
...
if database:get('MARKSTG:'..bot_id..'repowner:mute'..msg.chat_id_) then
send(msg.chat_id_, msg.id_, 1, '☑┇ردود المدير عام بالفعل تم تعطيلها', 1, 'md')
else
...
name = string.gsub(name,'🎚','🎚')
name = string.gsub(name,'☎️','☎️')
keko_MARKSTG = 'اسرع واحد يدز » {`'..name..'`}'
send(msg.chat_id_, msg.id_, 1,keko_MARKSTG, 1, 'md')
end
...
keko_MARKSTG = 'اسرع واحد يرتبها » {'..name..'}'
send(msg.chat_id_, msg.id_, 1,keko_MARKSTG, 1, 'md')
end
...
keko_MARKSTG = 'اول واحد يحلها » {'..name..'}'
send(msg.chat_id_, msg.id_, 1,keko_MARKSTG, 1, 'md')
end
...
keko_MARKSTG = '*💎¦ ليس لديك مجوهرات \n📬¦ للحصول على مجوهرات ارسل الاسرع وابدأ اللعب*\n'
send(msg.chat_id_, msg.id_, 1,keko_MARKSTG, 1, 'md')
else
keko_MARKSTG = '*💎¦ عدد مجوهراتك الحاليه  ('..(database:get('MARKSTG:'..bot_id..'add:num'..msg.chat_id_..msg.sender_user_id_))..')*'
keko_MARKSTG1 = '*💎¦ مجموع مجوهراتك  ('..(database:get('MARKSTG:'..bot_id..'add:numall'..msg.chat_id_..msg.sender_user_id_))..')*'

send(msg.chat_id_, msg.id_, 1,''..keko_MARKSTG..'\n'..keko_MARKSTG1..'', 1, 'md')
end
end
...
keko_MARKSTG = (database:get('MARKSTG:'..bot_id..'add:num'..msg.chat_id_..msg.sender_user_id_) * tonumber(database:get('MARKSTG:'..bot_id..'gamepoint' .. msg.chat_id_)or 50))
database:incrby('MARKSTG:'..bot_id..'nummsg'..msg.chat_id_..msg.sender_user_id_,keko_MARKSTG)  
database:del('MARKSTG:'..bot_id..'add:num'..msg.chat_id_..msg.sender_user_id_)
keko_MARKSTG = tonumber((database:get('MARKSTG:'..bot_id..'gamepoint' .. msg.chat_id_) or 50))
send(msg.chat_id_, msg.id_, 1,'💎¦ تم بيع جواهرك كل مجوهره تساوي '..keko_MARKSTG..' رساله', 'md')
end
end


if text == 'تفعيل اللعبه' and is_owner(msg) then   
keko_MARKSTG = '*📛¦*تم تفعيل اللعبه  ✔' 
send(msg.chat_id_, msg.id_, 1,keko_MARKSTG, 1, 'md')
database:set('MARKSTG:'..bot_id..'lock_geam'..msg.chat_id_,true)  
end
if text == 'تعطيل اللعبه' and is_owner(msg) then  
keko_MARKSTG = '*📛¦*تم تعطيل اللعبه  ❌' 
send(msg.chat_id_, msg.id_, 1,keko_MARKSTG, 1, 'md')
